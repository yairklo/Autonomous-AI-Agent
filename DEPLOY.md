...
# | WhatsApp / Puppeteer | Image runs `npx puppeteer browsers install chrome` at build; `PUPPETEER_CACHE_DIR=/root/.cache/puppeteer`. Optional override: `PUPPETEER_EXECUTABLE_PATH`. |
#
