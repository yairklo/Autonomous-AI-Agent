...
const defaultSystemPrompt = [
  ...
  'When the user asks to scan WhatsApp groups for jobs and/or submit CVs (Hebrew or English),',
  'stay in Grill-Me Mode and cover domain-specific topics in addition to the defaults above:',
  ...
  'Do not implement or dispatch the WhatsApp/CV tool until the user confirms the refined spec',
  '(or explicitly skips Grill-Me Mode).',
  '',
